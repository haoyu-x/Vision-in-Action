...
class ReadiPhone:
    def __init__(self):
        ...
        # ROS Publishers
        self.pub_RGB = rospy.Publisher("/camera/iphone_rgb", CompressedImage, queue_size=10)
        self.pub_Depth = rospy.Publisher("/camera/iphone_depth", Image, queue_size=10)
        self.pub_extrinsic = rospy.Publisher("/camera/iphone_extrinsic", JointState, queue_size=10)
        self.pub_intrinsic = rospy.Publisher("/camera/iphone_intrinsic", JointState, queue_size=10)
