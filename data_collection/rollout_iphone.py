...
def subsample_bag(rosbag_path: Path, save_new=True):
    ...
    for i in range(len(right_RGB_msgs)):
        if i%downsample_rate ==0:
            ...
            iphone_frames.append(cv2.cvtColor(main_rgb_msg_arr, cv2.COLOR_BGR2RGB))
            ...
            right_RGB_arr = cv2.cvtColor(right_RGB_arr, cv2.COLOR_BGR2RGB)  
            ...
            left_RGB_arr = cv2.cvtColor(left_RGB_arr, cv2.COLOR_BGR2RGB)
            ...
            top_RGB_arr = cv2.cvtColor(top_RGB_arr, cv2.COLOR_BGR2RGB)
    ...
    # output_file = '/home/haoyux/'+name_without_ext+'exo_output_video.mp4'
    # iio.imwrite(output_file, exo_frames, fps=frame_rate, plugin="pyav", codec="libx264")


    output_file = '/home/haoyux/'+name_without_ext+'_iphone_output_video.mp4'
    iio.imwrite(output_file, iphone_frames, fps=frame_rate, plugin="pyav", codec="libx264")


    output_file = '/home/haoyux/'+name_without_ext+'_chest_output_video.mp4'
    iio.imwrite(output_file, chest_frames, fps=frame_rate, plugin="pyav", codec="libx264")

    output_file = '/home/haoyux/'+name_without_ext+'_right_wrist_video.mp4'
    iio.imwrite(output_file, right_wrist_frames, fps=frame_rate, plugin="pyav", codec="libx264")

    output_file = '/home/haoyux/'+name_without_ext+'_left_wrist_video.mp4'
    iio.imwrite(output_file, left_wrist_frames, fps=frame_rate, plugin="pyav", codec="libx264")
