...
PORT_CONFIG_MAP: Dict[str, DynamixelRobotConfig] = {
    # right
   "/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FT94EL3G-if00-port0": DynamixelRobotConfig(
        ...
        gripper_config=(7, 248, 290),
    ),

    # [ 3.381 50.921 47.041  3.611  3.151 45.049]


    # left
    "/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FTA2U2NG-if00-port0": DynamixelRobotConfig(

#    "/dev/serial/by-id/usb-FTDI_6014_FT94EL3G-if00-port0": DynamixelRobotConfig(
        joint_ids=(1, 2, 3, 4, 5, 6),
        joint_offsets=(
            2 * np.pi / 2,
            1 * np.pi / 2,
        ...
        joint_signs=(-1, 1, 1, -1, 1, 1),
        gripper_config=(7, 249, 291),
    ),

    # [-4.527  51.041  47.148   3.553  -4.585 -44.869]
    # [-0.079  0.891  0.823  0.062 -0.08  -0.783]
