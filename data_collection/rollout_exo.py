...
def subsample_bag(rosbag_path: Path, save_new=True):
    ...
    for i in range(len(right_RGB_msgs)):
        if i%downsample_rate ==0:
            ...
            # iphone_frames.append(cv2.cvtColor(main_rgb_msg_arr))
            ...
            exo_frames.append(cv2.cvtColor(exo_rgb_msg_arr, cv2.COLOR_BGR2RGB))
