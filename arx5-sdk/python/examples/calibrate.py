...
@click.option("--urdf_path", "-u", default="../models/arx5_iphone15pro.urdf", help="URDF file path")
def calibrate_joint(model: str, interface: str, urdf_path: str):
    ...
    joint_controller.calibrate_joint(4)
    while True:
