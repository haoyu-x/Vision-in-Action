...
class Rollout:
    def __init__(self):
        ...
        # pot
        model_name = 'via_add_wrist_dinov2_cls_pot_three_vit_ema_200.pth'
        ...
        while not rospy.is_shutdown():
            ...
            while start_flag:        
                ...
                with torch.no_grad():
                    ...
                    right_image_features = nets['vision_encoder_right'].forward_features(nright_images)
                    right_image_features = right_image_features["x_norm_clstoken"] # [1, 256, 384])
                    
                    left_image_features = nets['vision_encoder_left'].forward_features(nleft_images)
    ...
    def _get_obs(self):
        ...
        while True:
            ...
            # wrist rgb input
            obs["right_RGB_arr"] = np.array(self.current_right_image)
            obs["left_RGB_arr"] = np.array(self.current_left_image)
    ...
    def load_model(self, action_dim, obs_horizon, lowdim_obs_dim, load_dir, model_name):
        ...
        head_dinov2_vits14 = dinov2_vits14.cuda()


        dinov2_vits14 = torch.hub.load('facebookresearch/dinov2', 'dinov2_vits14')
        vision_encoder_right = dinov2_vits14.cuda()

        dinov2_vits14 = torch.hub.load('facebookresearch/dinov2', 'dinov2_vits14')
        vision_encoder_left = dinov2_vits14.cuda()
