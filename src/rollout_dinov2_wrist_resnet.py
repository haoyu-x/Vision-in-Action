...
class Rollout:
    def __init__(self):
        ...
        # pot
        model_name = 'via_add_wrist_dinov2_cls_pot_ema_500.pth'
        ...
        while not rospy.is_shutdown():
            ...
            while start_flag:        
                ...
                with torch.no_grad():
                    ...
                    right_image_features = nets['vision_encoder_right'](nright_images)
                    left_image_features = nets['vision_encoder_left'](nleft_images)
    ...
    def load_model(self, action_dim, obs_horizon, lowdim_obs_dim, load_dir, model_name):
        ...
        obs_dim = 2*512 + 384 + lowdim_obs_dim
